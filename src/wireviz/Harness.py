        ...
        for key, connector in self.connectors.items():
            if connector.category == 'ferrule':
                ...
                rows = [[connector.manufacturer,
                        ...
                        [html_line_breaks(connector.type), html_line_breaks(connector.subtype), wv_colors.translate_color(connector.color, "HEX"), '<!-- colorbar -->' if connector.color else None],
